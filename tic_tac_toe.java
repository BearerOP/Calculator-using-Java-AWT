...
public class tic_tac_toe implements ActionListener {
    ...
    tic_tac_toe() {
        ...
        b1.setBounds(40, 60, 50, 50);
        b2.setBounds(90, 60, 50, 50);
        b3.setBounds(140, 60, 50, 50);
        b4.setBounds(40, 110, 50, 50);
        b5.setBounds(90, 110, 50, 50);
        b6.setBounds(140, 110, 50, 50);
        b7.setBounds(40, 160, 50, 50);
        b8.setBounds(90, 160, 50, 50);
        b9.setBounds(140, 160, 50, 50);
        t1.setBounds(40, 250, 150, 40);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (b1.getLabel().equals(b2.getLabel()) && b1.getLabel().equals(b3.getLabel())) {
            ...
            b8.setEnabled(false);
            b9.setEnabled(false);
        } else if (b5.getLabel().equals(b4.getLabel()) && b5.getLabel().equals(b6.getLabel())) {
            win = entry;
            t1.setText("Winner is " + win + " Player");
            b1.setEnabled(false);
            b2.setEnabled(false);
